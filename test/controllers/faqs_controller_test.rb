...
class FaqsControllerTest < ActionController::TestCase
  ...
  test "should create faq" do
    assert_difference('Faq.count') do
      post :create, faq: { answer: @faq.answer, more-info: @faq.more-info, question: @faq.question }
    end
  ...
  test "should update faq" do
    patch :update, id: @faq, faq: { answer: @faq.answer, more-info: @faq.more-info, question: @faq.question }
    assert_redirected_to faq_path(assigns(:faq))
  end
